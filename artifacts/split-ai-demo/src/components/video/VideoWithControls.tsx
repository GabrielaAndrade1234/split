...
const SCENE_DETAILS: Record<string, { title: string; filePath: string }> = {
  intro: {
    title: 'Abertura',
    filePath: 'src/components/video/video_scenes/Scene0Intro.tsx',
  },
  typing: {
    title: 'Pedido em linguagem natural',
    filePath: 'src/components/video/video_scenes/Scene1Typing.tsx',
  },
  autofill: {
    title: 'Preenchimento pela IA',
    filePath: 'src/components/video/video_scenes/Scene2Autofill.tsx',
  },
  metrics: {
    title: 'Tokens, custos e cache',
    filePath: 'src/components/video/video_scenes/Scene3Metrics.tsx',
  },
  outro: {
    title: 'Encerramento',
    filePath: 'src/components/video/video_scenes/Scene4Outro.tsx',
  },
};
